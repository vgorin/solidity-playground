...
*/
	...
	const offset0 = new Date('2018-01-18T00:00').getTime() / 1000 | 0;
	const length0 = 3600;
	...
	const offset1 = new Date('2018-01-18T00:00').getTime() / 1000 | 0;
	const length1 = 3600;
	...
	const offset2 = new Date('2018-01-18T00:00').getTime() / 1000 | 0;
	const length2 = 3600;
